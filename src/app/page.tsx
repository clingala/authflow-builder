...
const phases = [
  ...
  { name: "Deployment readiness", detail: "Containers, migrations, monitoring, backups, and runbooks", state: "Complete" },
];
    ...
    <div className="app-shell">
      <aside className="sidebar" aria-label="Primary navigation">
        ...
        <div className="sidebar-note">
          ...
          <div><strong>MVP foundation ready</strong><small>All 15 implementation phases delivered</small></div>
        </div>
      </aside>
  ...
  "verification": ["email", "phone"]
        ...
        <section id="roadmap" className="section-block" aria-labelledby="roadmap-title">
          <div className="section-heading">
            ...
            <span className="phase-counter">15 / 15</span>
          </div>
